...
if __name__ == "__main__":
    ...
    spark = (
        ...
        .config(
            "spark.jars",
            "E:/Python/Project 2/RealtimeVotingEngineering/postgresql-42.7.4.jar",
        )  # PostgreSQL driver
        .config(
    ...
    votes_per_candidate_to_kafka = (
        ...
        .option(
            "checkpointLocation",
            "E:/Python/Project 2/RealtimeVotingEngineering/checkpoint/checkpoint1",
        )
        .outputMode("update")
        .start()
    )
    ...
    turnout_by_location_to_kafka = (
        ...
        .option(
            "checkpointLocation",
            "E:/Python/Project 2/RealtimeVotingEngineering/checkpoint/checkpoint2",
        )
        .outputMode("update")
        .start()
    )
